...
public class LoginGUI extends JFrame {
    ...
    public void setComponent() {
        ...
        try {
            Font pixelFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/fonts/Pixelette.ttf")).deriveFont(Font.BOLD, 52);
            loginTT.setFont(pixelFont);
        } catch (Exception e) {
            e.printStackTrace();;
        }
        loginTT.setBounds(178, 0, 202, 70);
        loginTT.setForeground(Color.WHITE);
        cp.add(loginTT);
