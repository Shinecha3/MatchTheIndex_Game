...
public class SignUpGUI extends JFrame {
    ...
    public void setComponent() {
        ...
        try {
            Font pixelFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/fonts/Pixelette.ttf")).deriveFont(Font.BOLD, 40);
            signupTT.setFont(pixelFont);
        } catch (Exception e) {
            e.printStackTrace();;
        }
        signupTT.setForeground(Color.WHITE);
        signupTT.setBounds(163, 0, 202, 70);
        cp.add(signupTT);
        ...
        try {
            Font pixelFont = Font.createFont(Font.TRUETYPE_FONT, new File("src/fonts/Pixelette.ttf")).deriveFont(Font.BOLD, 20);
